      ...
      <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 rounded-[2.5rem] border border-[#E5E7EB] shadow-[0_20px_50px_rgba(0,0,0,0.04)] relative">
        ...
        <div className="prose prose-slate max-w-none text-[#475569] space-y-8">
            <section>
                ...
                <p>
                    ValueBet AI es una plataforma de análisis estadístico impulsada por inteligencia artificial. Nuestro servicio consiste en proporcionar predicciones, cálculos de probabilidades ("value bets") y análisis de datos relacionados con eventos deportivos (principalmente fútbol). 
                    <strong>ValueBet AI NO es una casa de apuestas</strong>, no organiza juegos de azar, ni capta fondos para realizar apuestas en nombre de terceros. Somos exclusivamente un proveedor de información y software analítico.
                </p>
            </section>
            ...
            <section>
                ...
                <p>
                    ...
                    <strong>ValueBet AI no garantiza ganancias económicas de ningún tipo.</strong> Las rentabilidades pasadas o mostradas en la plataforma ("Rendimiento del último trimestre") se basan en simulaciones o históricos y no son indicadores fiables de resultados futuros.
                </p>
                <p>
                    El usuario es el único y exclusivo responsable de cualquier decisión de apuesta que realice basándose en la información proporcionada por nuestra plataforma. ValueBet AI y sus creadores, afiliados o empleados no asumen ninguna responsabilidad por pérdidas directas, indirectas, incidentales o consecuentes que resulten del uso de nuestra herramienta.
                </p>
            </section>
            ...
            <section>
                ...
                <p>
                    El acceso a las funcionalidades "Pro" de ValueBet AI requiere una suscripción mensual. El pago se procesa de forma segura a través de nuestro proveedor (Stripe).
                </p>
            ...
            <section>
                ...
                <p>
                    Todo el contenido, algoritmos, modelos de IA, bases de datos, código fuente, diseño, logotipos y textos alojados en ValueBet AI son propiedad exclusiva de los creadores de la plataforma. 
                    Está terminantemente prohibido extraer, copiar, distribuir, raspar (scraping) o revender las predicciones y cuotas proporcionadas por ValueBet AI sin autorización expresa y por escrito.
                </p>
            </section>
