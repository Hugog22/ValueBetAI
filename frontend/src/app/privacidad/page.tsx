...
export default function PrivacidadPage() {
    return (
        <div className="min-h-screen bg-[#051209] text-white py-20 px-6 font-sans">
            <div className="max-w-3xl mx-auto">
                <h1 className="text-4xl font-editorial font-bold mb-8 text-[#C0FF00]">Política de Privacidad</h1>
                ...
                <div className="space-y-8 text-[#cbd5e1] leading-relaxed text-sm">
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-white mb-4">3. Cómo Usamos tus Datos</h2>
                        <p className="mb-2">Tus datos personales se utilizan para las siguientes finalidades:</p>
                        <ul className="list-disc pl-6 space-y-2">
                            <li>Proporcionarte acceso y mantener tu cuenta en la plataforma de ValueBet AI.</li>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-white mb-4">4. Compartir tus Datos</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-white mb-4">6. Seguridad de los Datos</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-white mb-4">7. Tus Derechos Legales (RGPD)</h2>
                ...
                <div className="mt-12 pt-8 border-t border-white/10 flex justify-center">
                    <a href="/" className="text-[#C0FF00] hover:text-white transition-colors text-sm font-bold uppercase tracking-wider">
                        ← Volver a Inicio
                    </a>
                </div>
            </div>
